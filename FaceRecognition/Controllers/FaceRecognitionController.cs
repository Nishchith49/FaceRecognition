...
namespace FaceRecognition.Controllers
{
    ...
    public class FaceRecognitionController : ControllerBase
    {
        ...
        public FaceRecognitionController(FaceRecognitionDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> UploadFace([FromBody] FaceImageUploadModel model)
        {
            ...
            try
            {
                ...
                return Ok("Face saved successfully.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> TrainModel()
        {
            try
            {
                ...
                if (!images.Any())
                    return BadRequest("No training data found.");
        ...
        public async Task<IActionResult> PredictUser([FromBody] FaceImageUploadModel model)
        {
            if (!System.IO.File.Exists(_modelPath))
                return BadRequest("Model not found. Please train first.");
            ...
            try
            {
                ...
                foreach (var face in faces)
                {
                    ...
                    return Ok($"Match found: UserId {userId}, Confidence: {result.Distance}");
                }

                return BadRequest("Face recognition failed.");
            }
            catch (Exception ex)
            {
